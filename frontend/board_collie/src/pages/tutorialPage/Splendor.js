    ...
    const setting = [
        [ // 0: 2명 세팅
            ...
            [
                ...
                '귀족 타일을 섞은 다음 3개를 펼쳐 놓아주세요. 남은 타일은 게임 중에 사용되지 않으므로 상자에 다시 넣어 둡시다.' // 3번 세팅 설명
            ],
            [
                settingImage + '4.png', // 4번 세팅 이미지
                '1. 마지막으로 집기 좋은 위치에 토큰을 색깔별로 분류하여 쌓아 놓아주세요.(황금 조커 토큰은 5개 모두 놓아주시고, 나머지 토큰들은 4개씩만 놓아주세요.)' // 4번 세팅 설명
            ]
        ],
        [ // 1: 3명 세팅
            [
                settingImage + '1.png', // 1번 세팅 이미지
                '개발 카드를 같은 단계별로 나눠서 섞어준 후, 테이블 중앙에 위와 같은 순서로 세로 열을 이루게 놓아주세요.' // 1번 세팅 설명
            ],
            [
                settingImage + '2.png', // 2번 세팅 이미지
                '각 단계별 개발 카드를 4장씩 펼쳐 놓아주세요.' // 2번 세팅 설명
            ...
            [
                ...
                '귀족 타일을 섞은 다음 4개를 펼쳐 놓아주세요. 남은 타일은 게임 중에 사용되지 않으므로 상자에 다시 넣어 둡시다.' // 3번 세팅 설명
            ],
            [
                settingImage + '4.png', // 4번 세팅 이미지
                '마지막으로 집기 좋은 위치에 토큰을 색깔별로 분류하여 쌓아 놓아주세요.(황금 조커 토큰은 5개 모두 놓아주시고, 나머지 토큰들은 5개씩만 놓아주세요.)' // 4번 세팅 설명
            ]
        ],
        [ // 2: 4명 세팅
            [
            ...
            [
                ...
                '귀족 타일을 섞은 다음 5개를 펼쳐 놓아주세요. 남은 타일은 게임 중에 사용되지 않으므로 상자에 다시 넣어 둡시다.' // 3번 세팅 설명
            ],
            [
                settingImage + '4.png', // 4번 세팅 이미지
